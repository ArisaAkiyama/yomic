...
using MyMangaApp.ViewModels; // For notification presumably, or just independent
...
namespace MyMangaApp.Core.Services
{
    ...
    public class DownloadService
    {
        ...
        public DownloadService(SourceManager sourceManager, LibraryService libraryService, NetworkService networkService)
        {
            ...
            // Base directory: AppData/MyMangaApp/Downloads
            var appData = Environment.GetFolderPath(Environment.SpecialFolder.LocalApplicationData);
            _downloadBaseDir = Path.Combine(appData, "MyMangaApp", "Downloads");
        ...
        public async Task<string> ExportToCbz(DownloadRequest request)
        {
            ...
            // Save to User's Downloads folder / MyMangaApp_Exports
            var userDownloads = Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.UserProfile), "Downloads");
            var exportFolder = Path.Combine(userDownloads, "MyMangaApp_Exports");
